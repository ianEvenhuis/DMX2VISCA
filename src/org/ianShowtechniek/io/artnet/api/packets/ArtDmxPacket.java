...
public class ArtDmxPacket extends ArtNetPacket {
    ...
    public void setDMX(byte[] dmxData, int numChannels) {
        ArtNet.logger.trace("setting DMX data for: " + numChannels + " channels");
    ...
    public void setUniverse(int subnetID, int universeID) {
        ...
        ArtNet.logger.trace("universe ID set to: subnet: " + ByteUtils.hex(subnetID, 2) + "/" + ByteUtils.hex(universeID, 2));
    }
